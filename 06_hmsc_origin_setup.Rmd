# (PART) Cat origin analysis {-}

# HMSC Setup

```{r load_data_hmsc_origin_setup, echo=FALSE}
load("data/data.Rdata")
```

## Generate input objects

```{r hmsc_origin_input, warning=FALSE, comments="", message=FALSE}
...
```{r hmsc_origin_formulas, warning=FALSE, comments="", message=FALSE}
...
```{r hmsc_origin_models, warning=FALSE, comments="", message=FALSE}
#Define models
model1 = Hmsc(Y=YData,
         XData = XData, 
         XFormula = XFormula,
...
if (!dir.exists("hmsc_origin")){dir.create("hmsc_origin")}
save(model_list, file = "hmsc_origin/hmsc.Rdata")
```
...
```{r hmsc_origin_mcmc, warning=FALSE, comments="", message=FALSE}
...
```{r hmsc_origin_executables, warning=FALSE, comments="", message=FALSE}
...
for(i in c(1:nrow(modelchains))){
      ...
      executablename <- paste0("hmsc_origin/exe_",modelname,"_",sample,"_",thin,".sh")
